...
Route::get('login', [\App\Http\Controllers\PageController::class, 'home'])->name('login');
...
Route::prefix('dashboard')->middleware('auth')->group(function () {
    ...
    Route::prefix('servers')->group(function () {
        Route::get('/', [PageController::class, 'servers'])->name('servers');
        Route::get('/{alias}', [PageController::class, 'server'])
